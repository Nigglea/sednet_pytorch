        ...
        if filter_file[1]=="pt":
            ...
            for th in thresholds:
                ...
                for j,aud in enumerate(testloader):
                    ...
                    with torch.no_grad():
                        pred_i = model.forward(tmbe,tstai)
                    label = tlabels.to('cpu')
                    ...
                    df_t = mt.save_batch_prediction(num,pred_t,categ,df)
                ...
                i+=1
                print('\n')
            os.makedirs('models/staimbe_v2/'+filter_file[0])
            shutil.move('models/staimbe_v2/'+fold_model,'models/staimbe_v2/'+filter_file[0]+'/'+fold_model)